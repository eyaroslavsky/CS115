'''Edward Yaroslavsky eyarosla 10/25/18
...
fibonacci = """
0   read r1         # Get n
1   setn r2 0       # First value of sequence 
2   setn r3 1       # Second value of sequence
3   jeqzn r1 5      # If r1 is 0, halt the program
4   jnezn r1 6      # Continue if n is not 0
5   halt            # Halts the program
6   write r2        # Prints first value of sequence
7   addn r1 -1      # Change r1 = r1 - 1
8   jeqzn r1 5      # If r1 is 0, halt the program
9   write r3        # Primts second value of sequence
10  addn r1 -1      # Change r1 = r1 - 1
11  jeqzn r1 5      # If r1 is 0, halt the program
12  add r4 r2 r3    # Change r4 = r2 + r3
13  write r4        # Print value of next term
14  addn r1 -1      # Change r1 = r1 - 1
15  jeqzn r1 5      # If r1 is 0, halt the program
16  copy r2 r3      # Change r2 = r3
17  copy r3 r4      # Change r3 = r4
18  jumpn 12        # Repeat
"""
